...
public class SubscribeErrorRouteReceiver {
	...
	private static final String QUEUE_NAME = "error_route_queue";
	...
	public static void main(String[] args) throws IOException, TimeoutException {
		...
		//4.绑定交换机
		channel.queueBind(QUEUE_NAME, EXCHANGE_NAME, ERROR_ROUTE);
		//5.同时间最多消费一个message
		channel.basicQos(1);
		...
		Consumer consumer = new DefaultConsumer(channel) {
			...
			public void handleDelivery(String consumerTag,Envelope envelop,AMQP.BasicProperties properties,
				...
				System.out.println("[ErrorRouteReceiver] receive message : " + message + " at " + new Date());
				...
				try {
                    ...
                    System.out.println("[ErrorRouteReceiver] receive done ");
