...
public class SubscribeSMSReceiver {

	private static final String EXCHANGE_NAME = "subscribe_fanout_exchange";
	private static final String QUENE_NAME = "sms_quene";
	...
	public static void main(String[] args) throws IOException, TimeoutException {
		...
		Consumer consumer = new DefaultConsumer(channel) {
			...
			public void handleDelivery(String consumerTag,Envelope envelop,AMQP.BasicProperties properties,
				...
				System.out.println("[SMSReceiver] receive message : " + message + " at " + new Date());
				...
				try {
                    ...
                    System.out.println("[SMSReceiver] receive done ");
